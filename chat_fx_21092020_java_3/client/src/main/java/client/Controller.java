...
public class Controller implements Initializable {
    ...
    private void SaveHistory() throws IOException {
        try {
            ...
            BufferedWriter bufferedWriter = new BufferedWriter(fileWriter); // буфер
            bufferedWriter.write(textArea.getText()); // передать из буфера тект ареи введдный текст
            bufferedWriter.close(); // закрыть буфер
